...
fn handle_add_confirm_up(app: &mut App) {
...
fn handle_add_confirm_down(app: &mut App) {
    if app.confirm_focused_field == 0 {
...
fn handle_add_confirm_horizontal(app: &mut App, code: KeyCode) {
...
fn handle_add_confirm_enter(app: &mut App) {
...
async fn handle_add_confirm_mode(app: &mut App, code: KeyCode) {
    match code {
        ...
        KeyCode::Up => handle_add_confirm_up(app),
        KeyCode::Down => handle_add_confirm_down(app),
        KeyCode::Left | KeyCode::Right => handle_add_confirm_horizontal(app, code),
        KeyCode::Enter if app.preview_info.is_some() => handle_add_confirm_enter(app),
        _ => {}
    }
}

pub const POKEMON_NAMES: &[&str] = &[
    ...
    "butterfree", "weedle", "beedrill", "pidgey", "pidgeotto",
    ...
    "seaking", "staryu", "starmie", "scyther", "jynx",
    ...
    "mewtwo", "mew", "chikorita", "cyndaquil", "totodile",
    "espeon", "umbreon", "murkrow", "misdreavus", "unown",
    "wobbuffet", "girafarig", "pineco", "forretress", "dunsparce",
    "steelix", "snubbull", "granbull", "scizor", "shuckle",
    "heracross", "sneasel", "teddiursa", "ursaring", "slugma",
    "magcargo", "swinub", "piloswine", "corsola", "remoraid",
    "octillery", "delibird", "skarmory", "houndour", "houndoom",
    ...
    "celebi", "treecko", "torchic", "mudkip", "gardevoir",
    "slakoth", "ninjask", "shedinja", "whismur", "loudred",
